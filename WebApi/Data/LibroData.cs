    ...
    public class LibroData
    {
        ...
        public static Libro Obtener(int id)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(Conexion.rutaConexion))
            {
                ...
                sb.AppendLine("INNER JOIN CATEGORIA c ON c.IdCategoria = l.IdCategoria");
                sb.AppendLine("INNER JOIN EDITORIAL e ON e.IdEditorial = l.IdEditorial");
                sb.AppendLine("WHERE l.IdLibro = @IdLibro");
        ...
        public static int Registrar(Libro libro)
        {
            int resultado = 0;
            using (var conexion = new SqlConnection(Conexion.rutaConexion))
            {
                try
                {
        ...
        public static bool Modificar(Libro objeto)
        {
        ...
        public static bool ActualizarRutaImagen(Libro objeto)
        {
            bool respuesta = true;
            using (SqlConnection oConexion = new SqlConnection(Conexion.rutaConexion))
            {
